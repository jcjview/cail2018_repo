...
def multi_preprocess(comments=[]):
    pool_size = 6 #multiprocessing.cpu_count() + 1
...
if __name__ == '__main__':
    ...
    print('reading...')
    alltext, accu_label, law_label, time_label,time_death,time_life  = data.read_trainData('../good/data_train.json.bz2')
    alltext1, accu_label1, law_label1, time_label1,time_death1,time_life1  = data.read_trainData('../good/data_valid.json.bz2')
    alltext2, accu_label2, law_label2, time_label2,time_death2,time_life2  = data.read_trainData('../good/data_test.json.bz2')
    ...
    df.to_csv('process.csv.bz2',compression='bz2')
    print(len(df))