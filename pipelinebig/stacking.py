...
test1 = np.load("cnn_model1_test.npy")
test2 = np.load("bgru_model1_test.npy")
...
blend=(test_accu3*0.9+test1+test2+test4)/4
calc(y_test,blend)

blend=(test_accu3*0.95+test1+test2+test4)/4
calc(y_test,blend)

blend=(test_accu3*0.85+test1+test2+test4)/4
calc(y_test,blend)


blend=(test_accu3*0.9+test1*0.8+test2+test4)/(3+0.8)
calc(y_test,blend)

X_valid = np.concatenate((test1, test2, test4,test_accu3), axis=1)
